                ...
                <div class="list-wrap">
                  <div class="p-img">
                    <router-link :to='`/detail/${good.id}`'>
                      <img :src="good.defaultImg" style="width: 215px;height: 255px;"/>
                    </router-link>
                  </div>
                  <div class="price">
                    <strong>
...
<script setup>
import { reactive,onMounted,onBeforeMount,computed,watch } from 'vue'
import {useStore} from 'vuex'
import { useRoute,useRouter } from 'vue-router'
import SearchSelector from './searchChild/searchSelect.vue'
...
function changeOrder(flag){
  let orginsFlag =searchParams.order.split(':')[0]
