<template>
  <div class="pay-main">
    <el-button type="primary" style="margin-left: 160px;">测试</el-button>
    <div class="pay-container">
      <div class="checkout-tit">
        ...
        <div class="paymark">
          <span class="fl">
            请您在提交订单
            <em class="orange time">半小时</em>之内完成支付，超时订单会自动取消。订单号：
            <em>{{ orderId }}</em>
          </span>
          <span class="fr">
...
async function getPayInfo() {
  let res = await reqPayInfo(orderId.value)
  if (res.code === 200) {
    payInfo.totalFee = res.data.totalFee
    payInfo.codeUrl = res.data.codeUrl
  }
}
